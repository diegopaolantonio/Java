...
public class ProductsController {
    ...
    @ApiResponses( value = {
            ...
            @ApiResponse(responseCode = "400", description = "Bad request: typing error, 'code, stock or price' cannot be null or 'code' already exists", content = @Content(mediaType = "", schema = @Schema())),
